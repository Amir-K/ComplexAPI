...
// NAMESPACE OBJECT: ./app/api/users/stats/route.ts
...
async function getData(_query, _params) {
    const query = `
    SELECT TOP 100
      c.FirstName,
      c.LastName,
...
const GET = (0,nodeclient/* withInstrumentation */.te)(async (request)=>{
    try {
...
var __webpack_exports__ = __webpack_require__.X(0, [447,580,960], () => (__webpack_exec__(51951)));
