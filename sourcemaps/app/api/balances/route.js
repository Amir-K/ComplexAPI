...
// NAMESPACE OBJECT: ./app/api/balances/route.ts
...
const GET = (0,nodeclient/* withInstrumentation */.te)(async ()=>{
    try {
        const response = await fetch(`https://balanceservice.livelybush-67f33f33.canadacentral.azurecontainerapps.io/api/balancechange`);
        const data = await response.json();
        if (!response.ok) {
            throw new Error(data.error || "Calculation service error");
        }
        const calculations = data.result.map((val, index)=>{
            const previousBalance = index === 0 ? 0 : data.result.slice(0, index).reduce((acc, curr)=>acc + curr, 0);
            const change = val;
...
;// ./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fbalances%2Froute&name=app%2Fapi%2Fbalances%2Froute&pagePath=private-next-app-dir%2Fapi%2Fbalances%2Froute.ts&appDir=C%3A%5CGit%5CComplexAPI%5Capp&appPaths=%2Fapi%2Fbalances%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
var __webpack_exports__ = __webpack_require__.X(0, [447,580,960], () => (__webpack_exec__(30415)));
